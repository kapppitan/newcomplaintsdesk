...
Route::group(['middleware' => 'auth'], function() {
    ...
    Route::get('/complaint/form/{id}', 'App\Http\Controllers\ComplaintController@form_index');
    Route::get('/complaint/form/print/{id}', 'App\Http\Controllers\ComplaintController@print_ccf');
    Route::get('/complaint/memo/{id}', 'App\Http\Controllers\OfficeController@memo_index');
